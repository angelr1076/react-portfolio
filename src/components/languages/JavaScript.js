    ...
    <div className="projects-grid">
      ...
      <Cell col={6}>
        ...
        >
          ...
          <CardText>
            Map Attack uses the REST Countries API and Google Maps API. The app
            allows the user to view specific country questions randomly
            generated by API data. The Google Maps API plots the given country's
            location onto the map with a pointer.
          </CardText>
          <CardActions border>
            <Button colored>
              <a
