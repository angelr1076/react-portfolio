    ...
    <div className="projects-grid">
      ...
      <Cell col={6}>
        ...
        >
          ...
          <CardText>
            Full-stack Node.js app for bird enthusiasts. It allows users to
            register, create a profile page, edit their description and add bird
            snaps. Bird Spotter uses MongoDB as its database. The app also uses
            Google Maps to plot out locations of where bird pics where taken.
          </CardText>
          <CardActions border>
            <Button colored>
              <a
      ...
      <Cell col={6}>
        ...
        >
          ...
          <CardText>
            ...
            generated by API data. The Google Maps API then plots the given
            country's location onto the map for viewing.
          </CardText>
          <CardActions border>
            <Button colored>
              <a
      ...
      <Cell col={6}>
        ...
        >
          ...
          <CardText>
            Recip-Ease uses Babel and Webpack, and is written in JavaScript. The
            app allows the user to create recipes, add instructions and add
            ingredients to each recipe -- checking and unchecking the available
            ingredients and updates the user on how many of their ingredients
            are available.
          </CardText>
          <CardActions border>
            <Button colored>
      ...
      <Cell col={6}>
        ...
        >
          ...
          <CardText>
            ...
            can find pets through a dropdown and search by zip code. Written in
            Vanilla JS.
          </CardText>
          <CardActions border>
            <Button colored>
