      ...
      <Grid className='landing-grid' style={{ marginTop: '80px' }}>
        ...
        <Cell col={6} tablet={12}>
          ...
          >
            ...
            <p>
              In mid-2018, after learning HTML, CSS, and some JavaScript, I
              decided to take a deeper dive into web development by enrolling in
              a web intensive boot-camp. This turned out to be the best
            ...
            <p>
              ...
              accomplish this by solving people’s day-to-day problems and by
              also making their jobs less complicated.
            </p>
          </div>
        </Cell>
      </Grid>
