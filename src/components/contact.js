        ...
        return (
            <div className="contact-body">
                <Grid className="contact-grid">
                    ...
                    <hr></hr>
                    <p className="skills" style={{ width: '90%', padding: '3px', margin: 'auto' }}>JavaScript | jQuery | React | Sass | ActiveRecord | Node.js | JSON | Phaser3 | Tiled | SQLite3 | Ruby | Ruby on Rails | Sinatra | Heroku | Firebase | Hugo | Bootstrap | Materialize | HTML5 | CSS3 | Git | Github</p>
