                ...
                <Grid className="landing-grid">
                    ...
                    <Cell col={6}>
                        <div className="landing-bio">
                            ...
                            <p style={{width: '75%', margin: '5%'}}>Prior to learning to program, I had many ideas that I wanted to put into action, but I had no clue where and how to start. At the time when I discovered that you didn't have to have a degree in computer science to solve technical problems, I realized I could empower myself, and others to learn to bring their ideas to life by chaining data together through code. </p> 
